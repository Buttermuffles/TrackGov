...
export default function Audit() {
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      <div><h1 className="text-xl lg:text-2xl font-bold text-slate-900">User Audit Trail</h1><p className="text-sm text-slate-500 mt-1">User activity log - {entries.length} entries</p></div>
